        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.1em', color: '#818cf8', textTransform: 'uppercase' }}>
                Scale Army · HR Dashboard
              </span>
            </div>
          ...
          <div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14, marginBottom: 28 }}>
              {PODS.map((p) => (
                <div
                  key={p.id}
                  onClick={() => setSelectedPod(selectedPod === p.id ? null : p.id)}
                  style={{
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    {p.buyout > 0 && (
                      <span style={{ fontSize: 11, background: '#7c3aed22', color: '#a78bfa', borderRadius: 4, padding: '2px 7px' }}>↗ {p.buyout} buyout</span>
                    )}
                  </div>
                  <div style={{ marginTop: 8, fontSize: 11, color: '#6666aa' }}>
                    avg tenure:{' '}
                    <span style={{ color: '#c7c7ff', fontWeight: 600 }}>{p.avgTenure} mo</span>
                  </div>
